...
scp -P 22334 $OUT_DIR/testo-cpu-x64.msi root@testo-lang.ru:/var/www/testo-lang.ru/dist/v${1}/testo-${1}-cpu-x64.msi
scp -P 22334 $OUT_DIR/testo-cpu-x86.msi root@testo-lang.ru:/var/www/testo-lang.ru/dist/v${1}/testo-${1}-cpu-x86.msi
...
scp -P 22334 $OUT_DIR/testo-guest-additions.iso root@testo-lang.ru:/var/www/testo-lang.ru/dist/v${1}/testo-guest-additions-${1}.iso
