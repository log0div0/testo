...
{cwd}/semantic/0006.testo:2:1: note: previous declaration was here""")
	...
	must_fail("testo run semantic/macro_call.testo --test_spec call_macro_action_outside_command", 		'Error: Unknown action: "Hello from macro"')
	...
	must_fail("testo run semantic/macro_call.testo --test_spec call_nested_macro2", 					'Error: Unknown action: "Hello from macro"')
