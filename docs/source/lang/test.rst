...
Атрибут ``[no_snapshots]`` у теста предписывает, что в конце выполнения теста для участвующих виртуальных машин не будут создаваться снепшоты гипервизора. Это может пригодиться для экономии места на диске.
