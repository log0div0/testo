...
export const terminal1 = (
	<Terminal height="200px">
		<span className="">C:\Users\Testo&gt; testo run hello_world.testo<br/></span>
...
export const terminal2 = (
	<Terminal height="400px">
		...
		<span className="blue bold">PROCESSED TOTAL 1 TESTS IN 0h:0m:4s<br/></span>
...
export const terminal3 = (
	<Terminal height="500px">
		...
		<span className="blue ">[  0%] Starting virtual machine </span>
		<span className="yellow ">my_ubuntu<br/></span>
		<span className="red bold">C:/Users/Testo/testo/hello_world.testo - hello world.testo:14:3: Caught abort action on virtual machine my_ubuntu with message: Stop here<br/><br/>C:/Users/Testo/testo/hello_world.testo - hello world.testo:2:1: note: the virtual machine my_ubuntu was declared here<br/><br/></span>
...
export const terminal4 = (
	<Terminal>
		<span className="">C:\Users\Testo&gt; sudo testo run ~/testo/hello_world.testo --stop_on_fail<br/></span>
		<span className="blue bold">TESTS TO RUN:<br/></span>
		<span className="magenta ">my_first_test<br/></span>
		<span className="blue ">[  0%] Preparing the environment for test </span>
		<span className="yellow ">my_first_test<br/></span>
...
export const terminal5 = (
	<Terminal height="150px">
		<span className="">C:\Users\Testo&gt; sudo testo clean<br/></span>
