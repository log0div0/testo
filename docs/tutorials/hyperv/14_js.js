...
export const terminal1 = (
	<Terminal height="600px">
		<span className="">C:\Users\Testo&gt; testo run tests.testo --stop_on_fail --param ISO_DIR C:\iso --assume_yes --test_spec install_ubuntu_desktop<br/></span>
		...
		<span className="blue ">with timeout 30m in virtual machine </span>
		<span className="yellow ">ubuntu_desktop<br/></span>
		<span className="blue ">[  0%] Waiting </span>
		...
		<span className="green bold"> PASSED in 0h:12m:58s<br/></span>
		<span className="blue bold">PROCESSED TOTAL 1 TESTS IN 0h:12m:58s<br/></span>
