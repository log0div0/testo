...
export const terminal1 = (
	<Terminal height="400px">
		<span className="">user$ sudo testo run handmade.testo --stop_on_fail --param VM_DISK_POOL_DIR /var/lib/libvirt/images<br/></span>
		...
		<span className="green bold"> PASSED in 0h:1m:13s<br/></span>
		<span className="blue bold">PROCESSED TOTAL 1 TESTS IN 0h:1m:13s<br/></span>
