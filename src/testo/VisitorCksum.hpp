...
struct VisitorCksum {
	...
	std::string visit_press(std::shared_ptr<VmController> vmc, std::shared_ptr<AST::Press> press);
	...
	std::string visit_sleep(std::shared_ptr<VmController> vmc, std::shared_ptr<AST::Sleep> sleep);
