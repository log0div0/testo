...
@test "prompt" {
	...
	run $TESTO_BIN run $BATS_TEST_DIRNAME/scripts/vm_config_changed.testo --hypervisor dummy --cache_miss_policy skip_branch
	...
	run $TESTO_BIN run $BATS_TEST_DIRNAME/scripts/fd_config_changed.testo --hypervisor dummy --cache_miss_policy skip_branch
