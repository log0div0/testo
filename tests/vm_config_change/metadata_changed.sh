...
OUTPUT=`ISO_FILE=$BASEDIR/iso.iso $TESTO_BIN $BASEDIR/scripts/base.testo --hypervisor dummy --cache_miss_policy accept`
...
OUTPUT=`ISO_FILE=$BASEDIR/iso.iso $TESTO_BIN $BASEDIR/scripts/metadata_changed.testo --hypervisor dummy --cache_miss_policy accept`
