---
id: 3_guest_additions
title: Часть 3. Гостевые дополнения
---
...
<br/><br/>
![CDROM plugged](assets/tutorials/3_guest_additions/plugged_cdrom.png)
<br/><br/>
...
<br/><br/>
![Tests tree](assets/tutorials/3_guest_additions/tests_tree.png)
<br/><br/>

Итоговый скрипт можно скачать [здесь](/docs/assets/tutorials/3_guest_additions/guets_additions.testo)